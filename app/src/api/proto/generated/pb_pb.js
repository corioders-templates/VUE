...
proto.pb.EchoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    message: jspb.Message.getFieldWithDefault(msg, 1, ""),
    error: (f = msg.getError()) && errors_errors_pb.Error.toObject(includeInstance, f)
  };
 ...
 */
proto.pb.EchoResponse.prototype.getError = function() {
 ...
 * @return {!proto.pb.EchoResponse} returns this
*/
proto.pb.EchoResponse.prototype.setError = function(value) {
 ...
 * @return {!proto.pb.EchoResponse} returns this
 */
proto.pb.EchoResponse.prototype.clearError = function() {
 ...
 * @return {boolean}
 */
proto.pb.EchoResponse.prototype.hasError = function() {
