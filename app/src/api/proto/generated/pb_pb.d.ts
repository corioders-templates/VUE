...
import * as errors_errors_pb from "./errors/errors_pb";
...
export class EchoResponse extends jspb.Message {
  ...
  hasError(): boolean;
  clearError(): void;
  getError(): errors_errors_pb.Error | undefined;
  setError(value?: errors_errors_pb.Error): void;
...
export namespace EchoResponse {
  export type AsObject = {
    message: string,
    error?: errors_errors_pb.Error.AsObject,
  }
}
